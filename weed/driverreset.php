...
include('function/driverreset.php');
            ...
            <form class="login-form" action="" method="post">
                ...
                <?php if(isset($_SESSION['msg']) && $_SESSION['msg']=='mismatch'){ ?>                    
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="email" value="<?php echo (isset($_SESSION['dreset']['email'])) ? $_SESSION['dreset']['email'] : ""; ?>" readonly="true"/> </div>
                    <div class="form-group">
