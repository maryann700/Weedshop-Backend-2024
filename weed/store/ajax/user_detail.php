 ...
 $html = '<div class="portlet blue-hoki box">
    ...
    <div class="portlet yellow-crusta box">
        ...
        <div class="portlet-body">
            ...
            $html .='</div>
            <div class="row static-info">';
                $html .= '<div class="col-md-4 name"> Recommendation: </div>';
                if(isset($user[0]['recommendation_photo']) && $user[0]['recommendation_photo']) {               
                   $html .= '<div class="col-md-4 name"> 
                        <a href="'.USER_UPLOAD_URL.$user[0]['recommendation_photo'].'" class="fancybox-button" rel="fancybox-button">
                            <img class="img-responsive" src="'.USER_UPLOAD_URL.$user[0]['recommendation_photo'].'" alt=""> 
                        </a>
                    </div>';
                } else {
                   $html .= '<div class="col-md-4 value">Not Added</div>';
    ...
    <div class="portlet green-meadow box">
        ...
        <div class="portlet-body">
            ...
            <div class="row static-info reject2" '.$numstyle.'>
                <div class="col-md-5 name"> Recommendation ID Number: </div>
                <div class="col-md-7 value"> 
                <input class="form-control" type="text" name="recomm_id" id="recomm_id" value="'.$user[0]['recommendation_id'].'" />
                </div>
            </div>
            <div class="row static-info reject" '.$resstyle.'>
                ...
                <div class="col-md-7 value"> 
                    <div class="mt-checkbox-list">
                        ...
                        <label class="mt-checkbox mt-checkbox-outline">
                            <input type="checkbox" name="reason[]" value="Recommendation"> Recommendation Photo Invalid
                            <span></span>
                        </label>       
                    </div>
                </div>
