...
<!--                                                                            <span class="label label-info label-sm"> Email confirmation was sent </span>-->
                                                                    ...
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> Order Status: <?php echo $order[0]['status']; ?></div>
                                                                        <div class="col-md-7 value">
                                                                            <span class="label label-<?php echo getOrderStatusClass($order[0]['status']); ?>"> <?php echo $order[0]['status']; ?> </span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row static-info">
                                                                        <div class="col-md-5 name"> Grand Total:<?php echo $order[0]['status']; ?> </div>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover table-bordered table-striped">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                ?>                                                                                    
                                                                                <tr>
                                                                                    <td><a class="pr-detail" data-id="<?php echo $products[$i]['product_id']; ?>"> <?php echo $products[$i]['name'] ?> </a></td>
