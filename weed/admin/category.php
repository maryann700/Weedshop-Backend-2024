...
<!--                                    <div class="caption font-dark">
                                    ...
                                    <div>
<!--                                        <a class="btn sbold green" href="category.php?id=add">Add New
                                        ...
                                        <form class="form-horizontal form-row-seperated" action="" method="post" enctype="multipart/form-data" id="frmproduct">
                                            ...
                                            <input type="hidden" name="action" value="addeditcat" />
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" required="true" class="form-control" name="category[name]" placeholder="" value="<?php echo $category['name']; ?>"> </div>
                                                        
                                                    <label class="col-md-1 control-label">Status:                                                       
                                                    </label>
                                                    <div class="col-md-3">
                                                        <select class="table-group-action-input form-control" name="category[status]">                                                                        
                                                    ...
                                                    <div class="col-md-3">
                                                        <button type="submit" name="save" value="save" class="btn btn-success">
                                                         ...
                                                         <a href="category.php" class="btn btn-success">Cancel</a>   
                                                    </div>
                                                    </div>
                                                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="category">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $categories[$i]['status']; ?></td>
                                                <td>
                                                    <div class="btn-group pull-left">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            <li>
                                                                <a href="category.php?id=<?php echo $categories[$i]['id']; ?>">
                                                                    <i class="fa fa-pencil"></i> Edit </a>
                                                            </li>
                                                            <li>
                                                                <a href="category.php?delete=<?php echo $categories[$i]['id']; ?>" onclick="ans = confirm('Are you sure for delete?'); if(ans == false){ return false;}">
