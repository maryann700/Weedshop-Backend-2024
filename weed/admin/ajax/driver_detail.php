...
$resstyle = "";
 ...
 $html = '<div class="portlet blue-hoki box">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cogs"></i>Driver Details </div>                                
        </div>
        <div class="portlet-body">
            ...
            <div class="row static-info">
                ...
                <div class="col-md-2 name"> Car Brand: </div>
                <div class="col-md-4 value"> '.$user[0]['car_brand'].' </div>     
            </div> 
            <div class="row static-info">
                <div class="col-md-2 name"> Admin Approved: </div>
                <div class="col-md-4 value"> '.$user[0]['adminApproved'].' </div>
                <div class="col-md-2 name"> Car Number: </div>
                <div class="col-md-4 value"> '.$user[0]['car_number'].' </div>     
            </div>';
    ...
    <div class="portlet yellow-crusta box">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cogs"></i>Driver Identifications </div>                               
        </div>
        <div class="portlet-body">
            <div class="row static-info">';
            ...
            $html .='</div>
            <div class="row static-info">';
                $html .= '<div class="col-md-4 name"> Car Document: </div>';
                if(isset($user[0]['car_document']) && $user[0]['car_document']) {               
                   $html .= '<div class="col-md-4 name"> 
                        <a href="'.USER_UPLOAD_URL.$user[0]['car_document'].'" class="fancybox-button" rel="fancybox-button">
                            <img class="img-responsive" src="'.USER_UPLOAD_URL.$user[0]['car_document'].'" alt=""> 
                        </a>
                    </div>';
                } else {
                   $html .= '<div class="col-md-4 value">Not Added</div>';
            ...
            <div class="row static-info reject" '.$resstyle.'>
                ...
                <div class="col-md-7 value"> 
                    <div class="mt-checkbox-list">
                        ...
                        <label class="mt-checkbox mt-checkbox-outline">
                            <input type="checkbox" name="reason[]" value="Car"> Car Document or detail Invalid
                            <span></span>
                        </label>       
                    </div>
                </div>
